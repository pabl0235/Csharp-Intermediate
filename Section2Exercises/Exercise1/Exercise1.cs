...
namespace Section2Exercises.Exercise1
{
    class Exercise1
    {
        /*
        ...
        {
            var input = "";
            Console.WriteLine("Press 's' to start stopwacth; 'p', to stop it; 'd', for the duration; 'exit' exit, lol.");
            while (input != "exit")
            {
                ...
                if (input == "d")
                {
                    ...
                    Console.WriteLine("Duration: {0}", Stopwatch.GetDuration());
                }
            }
        }
    }
